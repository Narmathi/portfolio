        ...
        <div className="flex items-center gap-3">
          ...
          >
            <svg
              ...
              aria-hidden="true"
            >
              <path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.11 1 2.5 1 4.98 2.12 4.98 3.5zM.22 8.5H4.8V24H.22V8.5zM8.34 8.5H12.7v2.1h.06c.61-1.15 2.11-2.36 4.34-2.36 4.64 0 5.5 3.05 5.5 7.02V24h-4.58v-7.65c0-1.82-.03-4.16-2.54-4.16-2.54 0-2.93 1.98-2.93 4.03V24H8.34V8.5z" />
            </svg>
          </a>
